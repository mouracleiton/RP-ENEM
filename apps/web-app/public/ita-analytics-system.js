/**
 * ITA RP Game - Performance Monitoring and Analytics System
 *
...
class ITAAnalyticsSystem {
    ...
    async init() {
        try {
            this.log('Initializing ITA Analytics System...');
    ...
    log(message, data = null) {
        if (this.config.debugMode) {
            console.log(`[ITA Analytics] ${message}`, data);
        }
    }

    logEvent(message, data = null) {
        if (this.config.debugMode) {
            console.log(`[ITA Analytics Event] ${message}`, data);
        }
    }

    logError(message, error = null) {
        console.error(`[ITA Analytics Error] ${message}`, error);
    }
}

// Instância global do sistema de analytics
window.itaAnalytics = new ITAAnalyticsSystem({
...
if (typeof module !== 'undefined' && module.exports) {
    module.exports = ITAAnalyticsSystem;
}
