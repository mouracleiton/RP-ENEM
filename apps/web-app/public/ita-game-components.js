// ITA RP Game Advanced Components
// Character Creator, Skill Tree, and Advanced Game Systems

class ITAGameComponents {
    constructor() {
        this.characterData = {
            basic: {
                name: '',
                        ...
                        <div class="achievements-grid">
                            ...
                            <div class="achievement-card unlocked" data-achievement="first-day">
                                ...
                                <div class="achievement-info">
                                    <h4>Primeiro Dia</h4>
                                    <p>Complete seu primeiro dia no ITA</p>
...
document.addEventListener('DOMContentLoaded', () => {
    window.gameComponents = new ITAGameComponents();
    window.gameComponents.setupKeyboardShortcuts();
});

// Export for external use
window.ITAGameComponents = ITAGameComponents;