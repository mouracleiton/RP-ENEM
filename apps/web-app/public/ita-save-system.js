// ITA RP Game Save/Load System with Cloud Storage
    ...
    async exportSave(saveId) {
        try {
            ...
            const exportData = {
                ...saveData,
                exportedAt: Date.now(),
                exportedBy: 'ITA RP Game Save System'
            };
...
document.addEventListener('DOMContentLoaded', () => {
    window.itaSaveSystem = new ITASaveSystem();
});

// Export for external use
window.ITASaveSystem = ITASaveSystem;