    ...
    getEmbeddedTranslations(language) {
        const translations = {
            'pt-BR': {
                ...
                // Notifications
                'notification.welcome': 'Bem-vindo ao ITA RP Game!',
            ...
            'en-US': {
                ...
                // Notifications
                'notification.welcome': 'Welcome to ITA RP Game!',
            ...
            'es-ES': {
                ...
                'notification.welcome': '¡Bienvenido al ITA RP Game!',
            ...
            'fr-FR': {
                ...
                'notification.welcome': 'Bienvenue dans ITA RP Game!',
            ...
            'ja-JP': {
                ...
                'skill.title': 'スキルツリー',
                'notification.welcome': 'ITA RPゲームへようこそ！',
            ...
            'zh-CN': {
                ...
                'skill.title': '技能树',
                'notification.welcome': '欢迎来到ITA RP游戏！',
                'common.loading': '加载中...',
                'common.error': '错误'
            }
        };
...
document.addEventListener('DOMContentLoaded', () => {
    window.itaLocalization = new ITALocalization();
...
window.ITALocalization = ITALocalization;