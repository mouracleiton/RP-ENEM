// ENEM RP Game Theme - Interactive Elements and Animations
...
class ENEMGameTheme {
    ...
    initializeNotifications() {
        this.showNotification('Bem-vindo ao ENEM RP Game!', 'success');
    ...
    showAboutDialog() {
        this.showDialog(
            'Sobre o ENEM RP Game',
            'Versão 1.0.0\n\nDesenvolvido com ❤️ no Instituto Tecnológico de Aeronáutica\n\nUm jogo de RPG inspirado na vida acadêmica do ENEM',
            ['Voltar']
        );
    }
}
...
document.addEventListener('DOMContentLoaded', () => {
    window.gameTheme = new ENEMGameTheme();
});

// Export for external use
window.ENEMGameTheme = ENEMGameTheme;