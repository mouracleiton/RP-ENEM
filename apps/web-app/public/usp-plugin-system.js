...
class ENEMPluginSystem {
    ...
    getCurrentLocation() {
        return 'ENEM Campus'; // This would get actual game location
    }
...
document.addEventListener('DOMContentLoaded', () => {
    window.itaPluginSystem = new ENEMPluginSystem();
    window.BasePlugin = BasePlugin;
});

// Export for external use
window.ENEMPluginSystem = ENEMPluginSystem;
window.BasePlugin = BasePlugin;
