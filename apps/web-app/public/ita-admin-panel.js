                ...
                <div class="admin-container">
                    ...
                    <div class="admin-header">
                        <div class="admin-logo">
                            ...
                            <span class="logo-text">ITA RP Admin</span>
                        </div>
                                        ...
                                        <div class="settings-panel active" id="settings-general">
                                            <div class="setting-group">
                                                ...
                                                <div class="setting-item">
                                                    ...
                                                    <input type="text" id="server-name" value="ITA RP Game Server" />
                                                </div>
                                                <div class="setting-item">
                                                    <label>Descrição</label>
                                                    <textarea id="server-description">Servidor oficial do ITA Role Playing Game</textarea>
                                                </div>
                                                <div class="setting-item">
            ...
            <div id="admin-login" class="login-overlay">
                <div class="login-container">
                    <div class="login-header">
                        ...
                        <p>ITA RP Game - Painel de Controle</p>
                    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    window.itaAdminPanel = new ITAAdminPanel();
});

// Export for external use
window.ITAAdminPanel = ITAAdminPanel;