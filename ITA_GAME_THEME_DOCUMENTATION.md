# ITA RP Game Theme - Documentação Completa

## 📋 Visão Geral

O ITA RP Game Theme é uma interface de jogo completa baseada no design institucional do Instituto Tecnológico de Aeronáutica (ITA). Este tema combina a identidade visual tradicional do ITA com elementos modernos de interface de jogos, criando uma experiência imersiva que conecta o mundo acadêmico do ITA com o universo de RPG.

## 🎨 Características de Design

### Cores Principais
- **Azul ITA Escuro**: `#133979` - Used for headers, primary elements
- **Vermelho ITA**: `#932D2D` - Used for accents, highlights, notifications
...
### JavaScript API
```javascript
// Classe principal: ITAGameTheme
const gameTheme = new ITAGameTheme();
